...
<img src="01d-how_to_acquire_data_files/figure-html//1ivDTcLjb2078O0GemkSeCgC1jmxk4fMsiFQaPaer9mQ_g3f65f827b50_0_0.png" alt="Learning Objectives: 1. List the major categories of clinical data sources, 2. Understand when a researcher may want to use one category of data sources over others, 3. Compare data sources in terms of where the data come from, what data are included, and ease of access" width="100%" style="display: block; margin: auto;" />
