...
<img src="03-data_management_files/figure-html//1ivDTcLjb2078O0GemkSeCgC1jmxk4fMsiFQaPaer9mQ_g3edc229d226_1_0.png" alt="Learning Objectives: Learning Objectives: 1. Understand the clinical data handling process and how to choose clinical data handling tools, 2. Explain privacy considerations for clinical data, 3. List major regulations and regulatory bodies for clinical data, 4. Describe different types of documents used when working with clinical data" width="100%" style="display: block; margin: auto;" />
...
<img src="03-data_management_files/figure-html//1ivDTcLjb2078O0GemkSeCgC1jmxk4fMsiFQaPaer9mQ_g3f5432c677a_0_370.png" alt="Diagram showing some steps of data handling, including data collection, data storage, data cleaning, data analysis, data sharing, and data reporting, and data auditing." width="100%" style="display: block; margin: auto;" />
...
<img src="03-data_management_files/figure-html//1ivDTcLjb2078O0GemkSeCgC1jmxk4fMsiFQaPaer9mQ_g3edc229d226_1_10.png" alt="Data quality is a component of data handling, image showing a small circle labeled data quality within a larger circle labeled data handling, the large circle also includes other aspects of data handling such as data collection and analysis" width="100%" style="display: block; margin: auto;" />
