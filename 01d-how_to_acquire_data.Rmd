...
SEER Research Data includes data from 1975-2023, excluding geographic region, month of diagnosis, and other demographic fields. Any user with an email address can access this data by registering [here](https://seerdataaccess.cancer.gov/seer-data-access). 
