...
When evaluating a source of clinical data, it is useful to understand why the data were collected, who is included in the data, what variables are available, what requirements, applications, or costs are associated with access.
...
The GDC includes genomic data that contributed by many NIH-funded cancer studies and external studies. A partial list of data sources can be found [here](https://gdc.cancer.gov/about-data/data-sources).
