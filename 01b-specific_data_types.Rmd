...
- [synthpop](https://cran.r-project.org/web/packages/synthpop/index.html): an R package that takes patient data with senstive values, and replaces those values with synthetic values, while minimally distorting the statistical summaries of the data set [@nowok2016synthpop]. 
