...
- Write a script that uses a probabilistic modeling framework to create a dataset with values that mimic what you expect to find. You can also remove data or add errors that might occur in your real data collection process
