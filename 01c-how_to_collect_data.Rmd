...
[placeholder for image to explain terms: outcome, exposure, intervention]
...
Clinical trials can face ethics, feasibility, and optimization challenges.  A trial would not be ethical when an intervention exposes participants to unnecessary risks (for example, giving patients a high dose of a new drug before knowing if there are side effects) or withholding access to a treatment that is already known to be beneficial. A trial is not feasible when studying a factor that can't be manipulated like an intervention or treatment, such as genetic factors, sex at birth, or environmental and occupational exposures that occur naturally. In some cases, a trial might be ethical and feasible but not optimal when researchers want to understand the effects of an intervention in the real world and not the tightly regulated environment of a clinical trial or when the cost of a clinical trial is too high. 
...
* Include data from low resource healthcare settings such as community health centers that provide care for patients who tend to have lower incomes and or live in rural areas.
